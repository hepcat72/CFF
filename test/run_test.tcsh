...
if ( $PASSES == 3 ) then
 ...
 if ( $FULLTEST == 0 ) then
  echo "Note: This test used pre-existing results from ../samples/Caporaso_*_out. To force a full re-test, please delete these directories and rerun this script."
 endif
endif
