...
#USAGE: tcsh run_example1.tcsh

setenv STARTTIME   `perl -e 'print(scalar(time()))'`
setenv Z           2
setenv K           2
setenv MAG         30
setenv INDIR       Caporaso_FASTA
setenv ANALYSISDIR Caporaso_FASTA_out
setenv GLOB        "L6S2?_19???.fna"
setenv LIB         example1.glib
...
echo ''
echo "RUNNING run_example1.tcsh"
echo "-------------------------"
